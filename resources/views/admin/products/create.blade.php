...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="total_page" class="form-control @error('total_page') is-invalid @enderror" id="total_page" value="{{ old('total_page') }}" min="1">
            @error('total_page')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="publish_years" class="form-control @error('publish_years') is-invalid @enderror" id="publish_years" value="{{ old('publish_years') }}" min="1900" max="{{ date('Y') }}">
            @error('publish_years')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="language" class="form-control @error('language') is-invalid @enderror" id="language" value="{{ old('language') }}">
            @error('language')
            <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
